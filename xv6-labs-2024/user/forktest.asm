...
forktest(void)
{
  ...
  36:	3b650513          	addi	a0,a0,950 # 3e8 <pgaccess+0x8>
  ...
  58:	3e450513          	addi	a0,a0,996 # 438 <pgaccess+0x58>
  ...
  6e:	38e50513          	addi	a0,a0,910 # 3f8 <pgaccess+0x18>
  ...
  80:	39450513          	addi	a0,a0,916 # 410 <pgaccess+0x30>
  ...
  b0:	37c50513          	addi	a0,a0,892 # 428 <pgaccess+0x48>
